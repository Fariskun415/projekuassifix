...
<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
            <h1 class="font-weight-bold text-dark">Tambah Matriks Keputusan</h1>
            
            <!-- Form tambah matriks keputusan -->
            <form action="<?= site_url('matrikskeputusan/store'); ?>" method="post">
                <?= csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="kode_alternatif" id="kode_alternatif" class="form-control" required>
                                ...
                                <?php foreach ($alternatif as $alt): ?>
                                    <option value="<?= $alt['kode_alternatif']; ?>"><?= $alt['kode_alternatif']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="kode_kriteria" id="kode_kriteria" class="form-control" required>
                                ...
                                <?php foreach ($kriteria as $kri): ?>
                                    <option value="<?= $kri['kode_kriteria']; ?>"><?= $kri['kode_kriteria']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="kode_periode" id="kode_periode" class="form-control" required>
                                <option value="">Pilih Kode Periode</option>
                                <?php foreach ($periode as $per): ?>
                                    <option value="<?= $per['kode_periode']; ?>"><?= $per['kode_periode']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="nilai" id="nilai" class="form-control" value="<?= old('nilai'); ?>" step="0.01" required>
                        </div>
                    </div>
                </div>
